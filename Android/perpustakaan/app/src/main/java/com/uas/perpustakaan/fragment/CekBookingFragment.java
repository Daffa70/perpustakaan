 ...
 */
public class CekBookingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_cek_booking, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        bookingAdapter.setAdapterListener(new BookingAdapter.BookingAdapterListener() {
            ...
            public void onItemClickListener(Booking booking) {
                ...
                intentdetail.putExtra("is_mine", false);
